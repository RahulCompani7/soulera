  ...
  <div className="container mx-auto px-20 py-6">
    <div className="flex items-center justify-between border-b border-gray-200 pb-4">
      ...
      <nav className="hidden md:flex items-center space-x-8">
        ...
        <motion.button className="text-base relative group" whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.95 }}>
      ...
      <main>
        ...
        <section className="container mx-auto px-4 py-24 text-center" ref={heroRef}>
          ...
          >
            <motion.h1 variants={itemVariants} className="text-5xl md:text-6xl font-extrabold mb-6">
            ...
            <motion.p variants={itemVariants} className="max-w-md mx-auto text-gray-500 text-base md:text-md mb-10 mt-10">
        ...
        <section className="container mx-auto px-4 py-16" ref={trustedRef}>
          <motion.div variants={containerVariants} initial="hidden" animate={trustedInView ? "visible" : "hidden"}>
            ...
            <motion.div className="flex flex-wrap justify-center items-center gap-10 md:gap-16">
  {Object.entries(companyLogos).map(([name, logo], i) => (
    ...
    >
      ...
      />
        ...
        {/* Features Highlight */}
       <section className="container mx-auto px-4 py-20" ref={feature1Ref}>
  <div className="grid md:grid-cols-2 gap-16 items-center mx-20">
    ...
    >
      ...
      <ul className="space-y-4">
        ...
        <section className="container mx-auto px-4 " ref={feature2Ref}>
          <div className="grid md:grid-cols-2 gap-16 items-center mx-20">
              <motion.div
              initial={{ opacity: 0, x: 50 }}
        ...
        {/* Features Grid */}
        <section className="container mx-auto px-20 py-20" ref={featuresGridRef}>
          <motion.div
            variants={containerVariants}
            initial="hidden"
...
>
  <feature.icon className="h-7 w-7 text-white" />
        ...
        {/* Team Section */}
        <section className="container mx-auto pl-20  bg-gray-50 py-20" ref={teamRef}>
         <motion.div
  variants={containerVariants}
  initial="hidden"
...
>
  ...
  >
         ...
         <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mr-20">
  {[
    ...
    >
      ...
      <motion.div
  className="w-[150px] h-[150px] rounded-full flex items-center justify-center mx-auto mb-5 p-2 "
  style={{ backgroundColor: `hsl(${Math.random() * 360}, 100%, 85%)` }} // Random light color
  whileHover={{ scale: 1.1, boxShadow: "0 0 0 4px rgba(167, 243, 208, 0.5)" }}
>
  <div className="w-[130px] h-[130px] rounded-full overflow-hidden">
    ...
    />
      ...
      <div className="flex justify-center mt-3 space-x-3">
        ...
        {/* Blog Section */}
        <section className="container mx-auto px-20 py-20 " ref={blogRef}>
          <motion.div
            variants={containerVariants}
            initial="hidden"
...
>
  ...
  <div className={`relative w-full h-80 ${post.IMGbgColor}`}>
    <Image
      src={imageMap[post.tag as keyof typeof imageMap]}
      alt={post.title}
      fill
    ...
    >
      <Card className="relative border-none shadow-sm h-full overflow-visible gap-0 m-0 p-0">
        ...
        <div className="absolute left-5 top-[13rem] z-10">
          <span
            className={`text-white ${post.bgColor} text-xs px-3 py-1 rounded-full font-medium shadow-md`}
          >
            {post.tag}
          </span>
        </div>
